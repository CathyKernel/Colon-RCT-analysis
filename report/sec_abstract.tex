...
proceeds in six modules: (i) Kaplan--Meier estimation, log-rank tests, and
Cox models with multiple imputation ($m=20$), proportional-hazards
diagnostics, competing-risk sensitivity analyses, and bootstrap absolute
...
number needed to treat $=6$). Under the redesigned sequential plan, the
