...
axes[0].set_title("Prior specifications for the treatment effect")
...
axes[0].set_xlabel("Information fraction (proportion of DFS events)")
...
axes[1].text(0.26, 0.955, "P(HR < 1) = 0.975 threshold",
             color=common.ACCENT, fontsize=8)
axes[1].set_xlabel("Information fraction (proportion of DFS events)")
