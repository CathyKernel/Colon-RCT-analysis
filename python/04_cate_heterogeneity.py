...
axes[0].set_xlabel("Predicted absolute benefit at 5 years\n"
                   "(risk reduction with Lev+5FU, percentage points)")
...
axes[1].set_xlabel("Predicted baseline 5-year risk under observation (%)")
